...
class Mathi extends StatefulWidget {
  const Mathi({Key? key}) : super(key: key);

  @override
  State<Mathi> createState() => _HomeState();
}

class _HomeState extends State<Mathi> {
  ...
  Widget build(BuildContext context) {
    ...
    // Handle cases where the title is not "Math"
